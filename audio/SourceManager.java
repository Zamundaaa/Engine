...
//		BLASTERSOUND = AudioMaster.loadJarSound("Laser_Blaster-SoundBible.ogg");
	...
	// TODO map sound paths -> IDs. And names -> IDs, too, if desirable
//	public static Source playSource(String soundpath, float volume, Vector3f position) {
//		Source s = getSource();
...
//	}
	...
	public static void play(int soundbuffer, float volume, Vector3f position) {
		playSource(soundbuffer, volume, position);
	}
