...
public class OBJFileLoader {
	...
	public static ModelData loadOBJ(String objFileName) {
		try {
			String finalpath = objFileName;
			if (!finalpath.endsWith(".obj"))
				finalpath += ".obj";
			InputStream fileinput;
			if (finalpath.startsWith("/")) {
				fileinput = new FileInputStream(new File(finalpath));
			} else {
				fileinput = OBJFileLoader.class.getClassLoader().getResourceAsStream(finalpath);
			}
			if (fileinput == null)
				AppFolder.log.println(finalpath);
			...
			AppFolder.log.println("Error reading the file " + objFileName);
		}
		return null;
	}
